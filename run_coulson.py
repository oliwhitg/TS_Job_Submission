                ...
                if intercepts in to_run_intercepts:
                    ...
                    for area in dict['{:}'.format(ref_run)]['{:}'.format(intercepts)]:
                        ...
                        if run_string == 'harmonic':
                            ...
                            start_TS_dynamic(False, 'blank', current_running_dir, float(int(intercept_100) / 100), float(int(area_1000) / 1000), ref_run, steps_to_run, dry_run)
                                ...
                                if 'crys.crds' not in os.listdir(out_dir + '/' + run_string + '/' + run_string + '_{:}'.format(restart_run_count)+'/intercept_{:}'.format(int(intercept_100))+'/area_{:}'.format(int(area))):
                                    ...
                                    if run_string == 'harmonic':
                                        ...
                                        start_TS_static(False, 'blank', current_running_dir, float(intercept_100 / 100),
                                                        float(area / 1000), restart_run_count+run_steps,
                                                        run_steps, dry_run)
                                        start_TS_dynamic(False, 'blank', current_running_dir, float(intercept_100 / 100),
                                                        float(area / 1000), restart_run_count+run_steps,
                                                        run_steps, dry_run)
    return 0
        ...
        for intercept_100 in dict_allowed_runs.keys():
            ...
            for area_1000 in dict_allowed_runs['{:}'.format(int(intercept_100))]:
                ...
                if run_string == 'harmonic':
                    ...
                    start_TS_dynamic(False, 'blank', current_running_dir, float(int(intercept_100)/100), float(int(area_1000)/1000), restart_run_count+run_steps,
                                    run_steps, dry_run)
    ...
    for intercept_100 in dict_allowed_runs.keys():
        ...
        for area_1000 in dict_allowed_runs['{:}'.format(int(intercept_100))]:
            ...
            if run_string == 'static':
                ...
                start_TS_dynamic(True, in_dir, current_running_dir, float(int(intercept_100)/100), area, restart_run_count,
                                run_steps, dry_run)
...
def start_TS_dynamic(new, input_folder, running_output_dir, intercept, area, restart_run_count, run_steps, dry_run):
    ...
    if new==True:
        ...
        ## remove harmlin ones
        for files in os.listdir(running_output_dir):
            if files in os.listdir(os.getcwd()+'/TS_Static/test2'):
                os.remove(running_output_dir + '/' + files)
        for files in os.listdir(os.getcwd()+'/TS_Dynamic/input'):
            copy(os.getcwd()+'/TS_Dynamic/input/'+files, running_output_dir)

        print('Restart Run Count : ', restart_run_count)
        print('Establishing Dipoles')
        shutil.move(running_output_dir + 'testout.rst', running_output_dir + 'setup_dipoles.crds')
        copy(running_output_dir + 'filenames.inpt', running_output_dir + 'filenames_original.inpt')
        #if new==False:
        with open(running_output_dir + 'filenames.inpt', 'w') as f:
            with open(running_output_dir + 'filenames_original.inpt', 'r') as g:
                for i in range(5):
                    f.write(g.readline())
                f.write('setup_dipoles.crds\n')
                skip = g.readline()
                for i in range(42 - 6):
                    f.write(g.readline())
        modify_runtime_dynamic_setup_dipoles(running_output_dir, run_steps)
        ...
        print('Restart Run Count : ', restart_run_count)
        print('Dipoles established, continuing run')
        shutil.move(running_output_dir + 'testout.rst', running_output_dir + 'pim.crds{:}'.format(restart_run_count))
        copy(running_output_dir + 'filenames.inpt', running_output_dir + 'filenames_original.inpt')
        #if new==False:
        with open(running_output_dir + 'filenames.inpt', 'w') as f:
            with open(running_output_dir + 'filenames_original.inpt', 'r') as g:
                ...
                for i in range(42 - 6):
                    f.write(g.readline())
        modify_runtime_dynamic_run_dipoles(running_output_dir, run_steps)
...
def modify_runtime_dynamic_setup_dipoles(dir, steps):
    with open(dir+'runtime_establish_dipoles.inpt', 'r') as input_file:
        with open(dir+'runtime.inpt', 'w') as output_file:
            output_file.write('{:<15}Number Steps in the run\n'.format(steps))
            skip = input_file.readline()
            for i in range(17):
...
def modify_runtime_dynamic_run_dipoles(dir, steps):
    #copy(dir+'runtime_licl.inpt', dir+'runtime_licl_original.inpt')
    with open(dir+'runtime_run_dipoles.inpt', 'r') as input_file:
        with open(dir+'runtime.inpt', 'w') as output_file:
            output_file.write('{:<15}Number Steps in the run\n'.format(steps))
            skip = input_file.readline()
            for i in range(17):
...
def make_subscript(working_dir, area_value):
    with open(working_dir+'/area_{:}/sub_script'.format(area_value), 'w') as filename:
        ...
        filename.write('#$ -S /bin/csh \n')
        filename.write('#$ -l s_rt=150:00:00 \n')
        filename.write('#$ -cwd \n')

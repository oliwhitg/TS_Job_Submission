...
c TMP
c LJ-ion rdfs into 'rdf.outx3' (x=1,2). LJ-LJ into 'rdf.out33'.
      if (ljsubsystem) then

         do 200 i=1,nspec

            filename=rdfname//indi(i:i)//indi(3:3)

            open(89,file=filename,status='new')
...
cc                  write(89,*) rlower,rdfpart(k,i,3)
  ...
  200    continue
         ...
         filename=rdfname//indi(3:3)//indi(3:3)
...
cc               write(89,*) rlower,rdfpart(k,3,3)
